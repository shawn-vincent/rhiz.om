...
export function Chat({ currentUserBeingId, beingId }: ChatProps) {
  ...
  return (
    <div className="relative flex h-full w-full max-w-3xl flex-col rounded-lg border border-white/20 bg-white/20 backdrop-blur-md shadow-lg ring-1 ring-white/25 p-4 pt-0">
